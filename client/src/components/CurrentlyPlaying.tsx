...
const CurrentlyPlaying = ({ data }: CurrentlyPlayingProps) => {
  ...
  return (
    <div className="w-2/3 mx-auto my-6 flex rounded-md shadow-md border-[1px] p-1">
      <div className="w-1/4 m-auto">
        <img src={albumImages && albumImages[0].url} className="rounded-md w-11/12 m-auto"></img>
      </div>
      <div className="my-auto w-3/4 h-fit">
        <span className="flex">
          <p className="mx-1 text-sm text-gray-500 truncate ...">Currently Listening</p>
          <DoubleClef />
        </span>
